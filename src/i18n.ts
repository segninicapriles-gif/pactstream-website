  ...
  pt: {
    ...
    comparison: {
      ...
      competitors: [
        ...
        {
          id: "built", name: "Built", country: "🇺🇸 EUA", tagline: "Gestao de draws para financiadores",
          color: "#2E86DE", pricing: "—", pricingDetail: "Preco nao publicado. Verificado no site a 18-ago-2026.",
          strengths: ["Lider de construction finance nos EUA", "Escala e dados do lado financiador", "Integrado no fluxo do banco"],
          weaknesses: ["O dinheiro fica no financiador, nao na plataforma", "A verificacao continua a ser uma inspecao presencial", "Produto para o financiador, nao para o construtor"],
          verdict: "A Built organiza o processo A VOLTA do inspetor humano: o proprio site oferece «take charge of your draw inspections». Nao verifica o avanco com IA nem guarda os fundos.",
          features: { escrow: "no", ai_verification: "no", auto_payment: "partial", milestone_payments: "yes", trust_score: "no", hito0_insurance: "no", ai_assistant: "no", geo_evidence: "no", multi_role: "no", ai_budgets: "no", mobile: "no", freemium: "no" },
        },
        {
          id: "buildots", name: "Buildots", country: "🌍 Global", tagline: "Verificacao por IA do avanco, sem tocar no dinheiro",
          color: "#8E44AD", pricing: "—", pricingDetail: "Preco nao publicado. Verificado no site a 18-ago-2026.",
          strengths: ["Referencia em verificacao do avanco com IA", "Registo verificavel do que foi executado", "Clientes internacionais de topo"],
          weaknesses: ["Nao guarda dinheiro nem liberta pagamentos", "A verificacao nao esta ligada ao recebimento", "Nao cobre orcamento nem fiscalidade"],
          verdict: "A Buildots e a melhor prova de que a verificacao por IA funciona — e de que sozinha nao recebe. No site nao ha custodia nem libertacao de pagamentos: verifica, e o dinheiro segue a parte.",
          features: { escrow: "no", ai_verification: "yes", auto_payment: "no", milestone_payments: "no", trust_score: "no", hito0_insurance: "no", ai_assistant: "no", geo_evidence: "no", multi_role: "no", ai_budgets: "no", mobile: "no", freemium: "no" },
        },
        {
          id: "paykeeper", name: "PayKeeper", country: "🇺🇸 EUA", tagline: "Custodia regulada com condicoes programaveis",
          color: "#16A085", pricing: "—", pricingDetail: "Preco nao publicado. Verificado no site a 18-ago-2026.",
          strengths: ["Custodia regulada a escala", "Condicoes de libertacao programaveis", "Nenhuma parte pode acelerar o pagamento sozinha"],
          weaknesses: ["Nao verifica o avanco fisico da obra", "As condicoes sao alimentadas por um terceiro", "Infraestrutura para plataformas, nao produto de obra"],
          verdict: "A PayKeeper e o reverso exato da Buildots: guarda o dinheiro e liberta por condicoes, mas nunca olha para a obra. Quem decide se o marco esta feito continua a ser outra pessoa.",
          features: { escrow: "yes", ai_verification: "no", auto_payment: "yes", milestone_payments: "yes", trust_score: "no", hito0_insurance: "no", ai_assistant: "no", geo_evidence: "no", multi_role: "no", ai_budgets: "no", mobile: "no", freemium: "no" },
        },
        {
    ...
    footer: {
      ...
      columns: {
        ...
        company: { title: "Ecossistema", links: ["CostPact", "FiscalCore", "PropertyJourney", "Lancamento", "Contacto"] },
      },
