  ...
  es: {
      ...
      profiles: [
        {
          ...
          priceSub: "Baja con el importe: 2,0% · 1,5% · 1,0% · 0,7%",
      ...
      plans: [
        {
          ...
          pactstream: ["Escalera del 2,4% al 0,7% por operación", "Escrow PSD2 + verificación IA", "Dashboard básico"],
          badge: "Gratis",
        },
        {
          tier: "Professional",
          ...
          pactstream: ["Escalera del 2,4% al 0,7% según importe", "Multi-obra + sello verificado", "IA ilimitada + reportes", "Trust Score público"],
          badge: null,
        },
        {
          tier: "Enterprise",
          ...
          popular: false,
          price: "desde 990€/mes",
          priceNote: "desde 0,8% tx · precio anual negociable",
          costpact: ["Todo Pro + catálogo privado", "Plantillas corporativas", "Multi-equipo + permisos", "Integración ERP (SAGE, A3)"],
          pactstream: ["desde 0,8% tx (suelo de la escalera)", "API + webhooks + SSO", "SLA 99,9% + CSM dedicado", "Audit logs + white-label"],
          badge: null,
        },
      ],
    },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "¿Cuánto cuesta usar PactStream?", a: "Ofrecemos 3 paquetes que incluyen CostPact (presupuestación IA) + PactStream (escrow + pagos). Starter: gratis, solo pagas la comisión por transacción, que baja con el importe de la obra — 2,4% hasta 100.000 €, 2,0% hasta 400.000 €, 1,5% hasta 1M€, 1,0% hasta 3M€ y 0,7% por encima. Professional: 99€/mes con presupuestos ilimitados, multi-obra y verificación IA ilimitada. Enterprise: desde 990€/mes con comisión desde 0,8%, API, SSO y CSM dedicado; se activa con GMV superior a 5M€ al año o con una sola obra de más de 3M€. Los primeros 50 usuarios obtienen pricing de fundador de por vida." },
  ...
  en: {
      ...
      profiles: [
        {
          ...
          priceSub: "Falls with the amount: 2.0% · 1.5% · 1.0% · 0.7%",
      ...
      plans: [
        {
          ...
          pactstream: ["Sliding rate from 2.4% to 0.7% per transaction", "PSD2 escrow + AI verification", "Basic dashboard"],
          badge: "Free",
        },
        {
          tier: "Professional",
          ...
          pactstream: ["Sliding rate from 2.4% to 0.7% by amount", "Multi-project + verified badge", "Unlimited AI + reports", "Public Trust Score"],
          badge: null,
        },
        {
          tier: "Enterprise",
          ...
          popular: false,
          price: "from €990/mo",
          priceNote: "from 0.8% tx · annual pricing negotiable",
          costpact: ["All Pro + private catalog", "Corporate templates", "Multi-team + permissions", "ERP integration (SAGE, A3)"],
          pactstream: ["from 0.8% tx (floor of the sliding scale)", "API + webhooks + SSO", "99.9% SLA + dedicated CSM", "Audit logs + white-label"],
          badge: null,
        },
      ],
    },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "How much does PactStream cost?", a: "We offer 3 bundles including CostPact (AI budgeting) + PactStream (escrow + payments). Starter: free, you only pay the transaction fee, which falls as the project grows — 2.4% up to €100,000, 2.0% up to €400,000, 1.5% up to €1M, 1.0% up to €3M and 0.7% above that. Professional: €99/mo with unlimited budgets, multi-project and unlimited AI verification. Enterprise: from €990/mo with fees from 0.8%, API, SSO and a dedicated CSM; it kicks in above €5M annual GMV or with a single project over €3M. The first 50 users get lifetime founder pricing." },
  ...
  pt: {
      ...
      profiles: [
        {
          ...
          priceSub: "Desce com o valor: 2,0% · 1,5% · 1,0% · 0,7%",
      ...
      plans: [
        {
          ...
          pactstream: ["Escala do 2,4% ao 0,7% por operação", "Escrow PSD2 + verificacao IA", "Dashboard basico"],
          badge: "Gratis",
        },
        {
          tier: "Professional",
          ...
          pactstream: ["Escala do 2,4% ao 0,7% consoante o valor", "Multi-obra + selo verificado", "IA ilimitada + relatorios", "Trust Score publico"],
          badge: null,
        },
        {
          tier: "Enterprise",
          ...
          priceNote: "desde 0,8% tx · preco anual negociavel",
          costpact: ["Tudo Pro + catalogo privado", "Modelos corporativos", "Multi-equipa + permissoes", "Integracao ERP (SAGE, A3)"],
          pactstream: ["desde 0,8% tx (piso da escala)", "API + webhooks + SSO", "SLA 99,9% + CSM dedicado", "Audit logs + white-label"],
          badge: null,
        },
      ],
    },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Quanto custa usar o PactStream?", a: "Oferecemos 3 pacotes que incluem CostPact (orcamentacao IA) + PactStream (escrow + pagamentos). Starter: gratis, so paga a comissão por transação, que desce com o valor da obra — 2,4% até 100.000 €, 2,0% até 400.000 €, 1,5% até 1M€, 1,0% até 3M€ e 0,7% acima disso. Professional: 99€/mes com orcamentos ilimitados, multi-obra e verificacao IA ilimitada. Enterprise: a partir de 990€/mes com comissão desde 0,8%, API, SSO e CSM dedicado; ativa-se com GMV acima de 5M€ por ano ou com uma única obra acima de 3M€. Os primeiros 50 utilizadores obtem preco de fundador vitalicio." },
